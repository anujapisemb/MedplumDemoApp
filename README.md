...
You can set communiation criteria In [`Home.tsx`](./src/Home.tsx#L91) as Communication?recipient=Patient/${patientId} to get communication related to patient received on the specified communication criteria
